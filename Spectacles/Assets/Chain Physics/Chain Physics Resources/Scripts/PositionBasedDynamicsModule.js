/** PositionBasedDynamicsModule.js
 * @module PositionBasedDynamicsModule
 * Description: Description: A Helper script that contains simple classes used for the position based dynamics simultaion
 * @author Snap Inc.
 * @version 1.0.0
* 
...
* ====  Example ====
* @example
* var PBD = require("./PositionBasedDynamicsModule")
**/
...
Point.prototype.getInverseMass = function () {
    return this.invMass;
};
...
Constraint.prototype.solve = function () {
    ...
    sumMass = this.particle0.getInverseMass() + this.particle1.getInverseMass();
    if (sumMass == 0) {
        return; //both static
    }
